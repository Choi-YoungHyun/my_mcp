...
def load_pptx(path: str) -> List[Document]:
    loader = Presentation(path)
    return loader



class MutilDocsRetrievalChain(RetrievalChain):
    ...
    def load_documents(self, source_uris: List[str]) -> List[Document]:
        ...
        for source_uri in source_uris:
            ...
            print(f"Selected Loader : {loader_dic[source_uri.split(".")[-1]]}")
            loader = loader_dic[source_uri.split(".")[-1]](source_uri)
    ...
    def create_vectorstore(self, split_docs: List[Document]) -> Any:
        ...
        if self.persist_directory:
            ...
            if os.path.exists(self.persist_directory) and any(os.listdir(self.persist_directory)):
                ...
                print(f"return data : {self.persist_directory}")
